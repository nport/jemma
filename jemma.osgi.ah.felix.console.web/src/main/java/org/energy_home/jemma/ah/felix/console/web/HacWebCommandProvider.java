...
public class HacWebCommandProvider extends org.apache.felix.webconsole.AbstractWebConsolePlugin {
			...
			if (pathInfo.startsWith("/confirm")) {
				...
				if (confirmParam.equals("delete"))
					pw.println("</br></br><b><font color=\"red\">Are you sure you want to delete appliance " + appliancePid
							+ "?&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL + "/delete/" + appliancePid
							+ "\">yes</a>&nbsp;&nbsp;&nbsp;" + "<a href=\"" + appRoot + "/" + LABEL + "\">no</a>");
			} else if (pathInfo == null || pathInfo.equals("") || pathInfo.equals("/") || pathInfo.startsWith("/install")
				...
				if (pathInfo.startsWith("/install")) {
					...
					pw.println("<br/><b><u>INSTALLING APPLIANCES</u>&nbsp;&nbsp;&nbsp;(<a href=\"" + appRoot + "/" + LABEL
							+ "/install\">Reload page</a>&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL
							+ "\">Go to installed appliances</a>)</b></br>");
					pw.println("<br/><b>[<a href=\"" + appRoot + "/" + LABEL
							+ "/install/open\">Open network</a>&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL
					...
					if (!installStatus)
						pw.println("<b><font color=\"red\">Some problem occurred while installing appliance " + installParam
								+ "</font></b>");
					pw.println("</br><hr/>");
				} else {
					v = appliancesProxy.getAppliancePids();
					v.add(PROXY_APPLIANCE_PID);
					pw.println("<br/><b><u>INSTALLED APPLIANCES</u>&nbsp;&nbsp;&nbsp;(<a href=\"" + appRoot + "/" + LABEL
							+ "\">Reload page</a>&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL
		...
		if (endPoints != null && endPoints.length > 1) {
			...
			if (!details) {
				...
				pw.println("&nbsp;(<a href=\""
						...
						+ appliancePid
						+ "\">Details</a>"
						+ (installing ? "&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL + "/install/" + appliance.getPid()
								+ "\">Install</a>" : "")
						+ (appliance.isSingleton() ? ")" : ("&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL
								+ "/confirm/delete/" + appliance.getPid() + "\">Delete</a>)")));
			} else {
				pw.print("<br/><u>APPLIANCE DETAILS</u>" + "&nbsp;&nbsp;(<a <a href=\"" + appRoot + "/" + LABEL + "/"
						+ appliancePid + "\">Reload page</a>&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL
						+ "\">Go to installed appliances</a>" + "&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL
			...
			pw.println("<br/>PID: " + appliance.getPid() + "<br/>TYPE: " + appliance.getDescriptor().getType()
					...
					+ ((location != null) ? "<br/>Location: " + location.getName() : "") + "</b><br/><br/>");
			if (isAvailable) {
				pw.println("</b>");
			} else {
				pw.println("</b></font>");
	...
	private void renderApplianceConfiguration(String appRoot, IApplianceConfiguration config, Integer endPointId, PrintWriter pw) {
		...
		pw.println((appliance.isDriver() ? "<b><u><br/>DRIVER" : "<b><u><br/>VIRTUAL") + " APPLIANCE</u>" + " (<a href=\""
				+ appRoot + "/" + LABEL + "/config/" + appliancePid + (endPointId != null ? ("/" + endPointId) : "")
				+ "\">Reload page</a>" + "&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL + "/" + appliancePid
				+ "\">Go to appliance details</a>)</br>" + "<br/>PID: " + appliance.getPid() + "<br/>TYPE: "
				+ appliance.getDescriptor().getType() + ((name != null) ? "<br/>Name: " + name : "")
				+ ((category != null) ? "<br/>Category: " + category.getName() : "")
				+ ((location != null) ? "<br/>Location: " + location.getName() : "") + "</b><br/><hr/>");

		pw.println("<br/><form name=\"ApplianceConfig\"" + " action=\"" + appRoot + "/" + LABEL + "/config/" + appliancePid
				+ (endPointId != null ? ("/" + endPointId) : "") + "\" method=\"get\">");
		...
		pw.println("<tr><td width=\"50%\">Name: </td><td><input type=\"text\" name=\"param\" size=\"30\" value=\"" + name
				+ "\"/></td></tr>");
		...
		if (categories != null && categories.length > 0) {
			...
			for (int i = 0; i < categories.length; i++) {
				...
				pw.println("<option value=\"" + pid + (pid.equals(categoryPid) ? "\" selected=\"selected\">" : "\" >")
		...
		if (locations != null && locations.length > 0) {
			...
			for (int i = 0; i < locations.length; i++) {
				...
				pw.println("<option value=\"" + pid + (pid.equals(locationPid) ? "\" selected=\"selected\">" : "\" >")
						+ locations[i].getName() + "</option>");
			}
			pw.println("</td></tr>");
		}
	...
	private void renderGetSubscriptionCommand(String appRoot, String appliancePid, int endPointId, String clusterName,
			String methodName, String result, PrintWriter pw) {
		pw.println("<br/><form name=\"" + GET_ATTRIBUTE_SUBSCRIPTION_METHOD + "\"" + " action=\"" + appRoot + "/" + LABEL + "/"
				+ appliancePid + "/" + endPointId + "/" + clusterName + "/" + GET_ATTRIBUTE_SUBSCRIPTION_METHOD
				+ "\" method=\"get\">");
		pw.println("<table id=\"" + GET_ATTRIBUTE_SUBSCRIPTION_METHOD + "\" class=\"nicetable\"><tbody>");
		pw.println("<tr><td width=\"50%\"><b>" + GET_ATTRIBUTE_SUBSCRIPTION_METHOD
				+ "</b></td><td><input type=\"submit\" value=\"invoke\"/></td></tr>");
		...
		if (methodName != null && GET_ATTRIBUTE_SUBSCRIPTION_METHOD.equals(methodName)) {
			pw.println("<tr><td><b><font color=\"red\">Result (ISubscriptionParameters):</font></b></td><td><b><font color=\"red\">"
					+ result + "</font></b></td></tr>");
		} else
	...
	private void renderSetSubscriptionCommand(String appRoot, String appliancePid, int endPointId, String clusterName,
			String methodName, String result, PrintWriter pw) {
		pw.println("<br/><form name=\"" + SET_ATTRIBUTE_SUBSCRIPTION_METHOD + "\"" + " action=\"" + appRoot + "/" + LABEL + "/"
				+ appliancePid + "/" + endPointId + "/" + clusterName + "/" + SET_ATTRIBUTE_SUBSCRIPTION_METHOD
				+ "\" method=\"get\">");
		pw.println("<table id=\"" + SET_ATTRIBUTE_SUBSCRIPTION_METHOD + "\" class=\"nicetable\"><tbody>");
		pw.println("<tr><td width=\"50%\"><b>" + SET_ATTRIBUTE_SUBSCRIPTION_METHOD
				+ "</b></td><td><input type=\"submit\" value=\"invoke\"/></td></tr>");
		pw.println("<tr><td width=\"50%\">AttributeName (String):</td><td><input type=\"text\" name=\"param\" size=\"100\"/></td></tr>");
	...
	private void renderClusterCommands(String appRoot, IApplianceConfiguration config, IEndPoint endPoint, String clusterName,
			String methodName, String[] params, PrintWriter pw) throws SecurityException, InstantiationException,
		...
		pw.println((appliance.isDriver() ? "<br><b><u>DRIVER APPLIANCE CLUSTER</u>" : "<br><b>VIRTUAL APPLIANCE CLUSTER</u>")
				+ "&nbsp;&nbsp;(<a <a href=\"" + appRoot + "/" + LABEL + "/" + appliancePid + "/" + endPointId + "/" + clusterName
				+ "\">Reload page</a>" + "&nbsp;&nbsp;&nbsp;<a href=\"" + appRoot + "/" + LABEL + "/" + appliancePid
				+ "\">Go to appliance details</a>)</br><hr/>");

		pw.println("<br>APPLIANCE<br/>&nbsp;&nbsp;&nbsp;PID: " + appliance.getPid() + "<br/>&nbsp;&nbsp;&nbsp;TYPE: "
				+ appliance.getDescriptor().getType() + ((name != null) ? "<br/>&nbsp;&nbsp;&nbsp;Name: " + name : "")
				+ ((category != null) ? "<br/>&nbsp;&nbsp;&nbsp;Category: " + category.getName() : "")
				+ ((location != null) ? "<br/>&nbsp;&nbsp;&nbsp;Location: " + location.getName() : "") + "<br/><br/>");
		...
		pw.println("<br/>END POINT" + "<br/>&nbsp;&nbsp;&nbsp;ID: " + endPointId + "<br/>&nbsp;&nbsp;&nbsp;TYPE: " + endPointType
				+ ((name != null) ? "<br/>&nbsp;&nbsp;&nbsp;Name: " + name : "")
				+ ((category != null) ? "<br/>&nbsp;&nbsp;&nbsp;Category: " + category.getName() : "")
		...
		try {
			...
			if (methodName != null && methodName.equals(GET_ATTRIBUTE_SUBSCRIPTION_METHOD)) {
				...
				if (!isEmpty(params[1]) || !isEmpty(params[2]) || !isEmpty(params[3])) {
					...
					sp = new SubscriptionParameters(minReportingInterval, maxReportingInterval, reportableChange);
				}
				result = TextConverter.getTextRepresentation(appliancesProxy.setAttributeSubscription(appliancePid, endPointId,
						clusterName, params[0], sp));
		...
		try {
			...
			if (lastNotifiedAttributeValues != null && lastNotifiedAttributeValues.size() > 0) {
				...
				for (Iterator iterator = lastNotifiedAttributeValues.entrySet().iterator(); iterator.hasNext();) {
					...
					pw.println("<tr><td width=\"30%\"><b><font color=\"red\">" + entry.getKey()
							+ ":</font></b></td><td><b><font color=\"red\">"
							+ TextConverter.getTextRepresentation(entry.getValue()) + "</font></b></td></tr>");
				}
			}
			...
			// methods[0] =
			// IServiceCluster.class.getMethod(GET_ATTRIBUTE_SUBSCRIPTION_METHOD,
			// new Class[] {String.class,
			// IEndPointRequestContext.class});
			// methods[1] =
			// IServiceCluster.class.getMethod(SET_ATTRIBUTE_SUBSCRIPTION_METHOD,
			// new Class[] {String.class,
			// ISubscriptionParameters.class, IEndPointRequestContext.class});
			// System.arraycopy(specificMethods, 0, methods, 2,
			// specificMethods.length);
			Class[] parameters = null;
			for (int i = 0; i < methods.length; i++) {
				pw.println("<br/><form name=\"" + methods[i].getName() + i + "\"" + " action=\"" + appRoot + "/" + LABEL + "/"
						+ appliancePid + "/" + endPointId + "/" + clusterName + "/" + methods[i].getName() + "#"
						+ methods[i].getName() + "\" method=\"get\">");
				pw.println("<table id=\"" + methods[i].getName() + i + "\" class=\"nicetable\"><tbody>");
				pw.println("<tr><td width=\"50%\"><b><a name=\"" + methods[i].getName() + "\">" + methods[i].getName()
				...
				for (int j = 0; j < parameters.length - 1; j++) {
					if (parameters[j].isArray()) {
						pw.println("<tr><td width=\"50%\">Param" + (j + 1) + " (array["
								+ parameters[j].getComponentType().getName()
								+ "]):</td><td><input type=\"text\" name=\"param\" size=\"100\"/></td></tr>");
					} else {
						pw.println("<tr><td width=\"50%\">Param" + (j + 1) + " (" + parameters[j].getName()
								+ "):</td><td><input type=\"text\" name=\"param\" size=\"100\"/></td></tr>");
					}
				}
				...
				if (methodName != null && methods[i].getName().equals(methodName)) {
					pw.println("<tr><td><b><font color=\"red\">Result (" + resultClassStr
							+ "):</font></b></td><td><b><font color=\"red\">" + formatResult(result) + "</font></b></td></tr>");
				} else
	...
	private void renderClusterList(String appRoot, String appliancePid, Integer endPointId, IServiceCluster[] clusterArray,
			PrintWriter pw) throws InstanceNotFoundException, IntrospectionException, ReflectionException {
	...
	private void renderClusterList(String appRoot, String appliancePid, IEndPoint endPoint, String[] clusterNameArray,
			PrintWriter pw) throws InstanceNotFoundException, IntrospectionException, ReflectionException {
	...
	private void renderEndPoints(String appRoot, IApplianceConfiguration config, IEndPoint[] endPoints, PrintWriter pw) {
		for (int i = 0; i < endPoints.length; i++) {
			...
			pw.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ENDPOINT");
			if (!appliance.isSingleton())
				pw.println("&nbsp;(<a href=\"" + appRoot + "/" + LABEL + "/config/" + appliancePid + "/" + endPointId
						+ "\">Configuration</a>)");
			pw.println("<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ID: " + endPoint.getId() + "<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TYPE: "
					+ endPoint.getType() + ((name != null) ? "<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name: " + name : "")
					+ ((category != null) ? "<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Category: " + category.getName() : "")
					+ ((location != null) ? "<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Location: " + location.getName() : ""));
			if (isAvailable)
