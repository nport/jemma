...
public class M2MXmlConverterJaxb extends XmlConverter implements M2MXmlConverter {
	private static M2MXmlConverterJaxb connectionInstance;
	private static M2MXmlConverterJaxb coreInstance;
	...
	public synchronized static M2MXmlConverterJaxb getConnectionConverter() {
		if (connectionInstance == null)
			connectionInstance = new M2MXmlConverterJaxb(JAXB_CONNECTION_CONTEXT_PATH,
					JAXB_CONNECTION_NAMESPACE, null, 1);
		return connectionInstance;
	}

	public synchronized static M2MXmlConverterJaxb getCoreConverter() {
		if (coreInstance == null) {
			coreInstance = new M2MXmlConverterJaxb(JAXB_CORE_CONTEXT_PATH, JAXB_CORE_NAMESPACE, 
					JAXB_CORE_NAMESPACES_PREFERRED_PREFIX_MAP,1);
		}
		return coreInstance;
	}

	protected M2MXmlConverterJaxb(String contextPath, String defaultNamespace, Map<String, String> nameSpacePreferredPrefixMap,
			int poolMaxSize) {
