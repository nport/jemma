...
public class HttpEntityXmlConverterJaxb extends XmlConverter implements HttpEntityXmlConverter {
	private static final Logger LOG = LoggerFactory.getLogger( HttpEntityXmlConverterJaxb.class );

	private static HttpEntityXmlConverterJaxb connectionInstance;
	private static HttpEntityXmlConverterJaxb coreInstance;
	...
	public synchronized static HttpEntityXmlConverter getCoreConverter() {
		if (coreInstance == null) {
			coreInstance = new HttpEntityXmlConverterJaxb(M2MXmlConverterJaxb.JAXB_CORE_CONTEXT_PATH, M2MXmlConverterJaxb.JAXB_CORE_NAMESPACE,  
					M2MXmlConverterJaxb.JAXB_CORE_NAMESPACES_PREFERRED_PREFIX_MAP, 1);
		}
		return coreInstance;
	}

	protected HttpEntityXmlConverterJaxb(String contextPath, String defaultNamespace, Map<String, String> nameSpacePreferredPrefixMap,
			int poolMaxSize) {
