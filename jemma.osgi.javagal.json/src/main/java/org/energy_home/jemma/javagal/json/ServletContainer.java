...
public class ServletContainer implements HttpSessionListener {
	...
	private void registerServlets() {
		try {
			 ...
			 */
			service.registerServlet(prefix + Resources.NWT_ROOT_URI + ResourcePathURIs.URI_FREQUENCY_AGILITY,
					new frequencyAgilityServlet(gatewayInterface), null, null);
			/*
			 * json/net/default/wsnnodes/nodedescriptorservicelist?timeout={0:x8}
			 * &address={1:x2/8}
			 */
			service.registerServlet(prefix + Resources.NWT_ROOT_URI + ResourcePathURIs.WSNNODES
					+ ResourcePathURIs.NODEDESCRIPTORSERVICELIST, new nodeDescriptorAndServicesServlet(gatewayInterface), null,
					null);
			 ...
			 */
			service.registerServlet(prefix + Resources.GW_ROOT_URI + ResourcePathURIs.RESET, new resetServlet(gatewayInterface),
					null, null);
			/*
			 * Defines PermitjoinAll route
			 * "json/net/default/allwsnnodes/permitjoin"
			 */
			service.registerServlet(prefix + Resources.NWT_ROOT_URI + ResourcePathURIs.ALLPERMIT_JOIN, new allPermitJoinServlet(
					gatewayInterface), null, null);
			/*
			 ...
			 */
			service.registerServlet(prefix + Resources.GW_ROOT_URI + ResourcePathURIs.STARTUP,
					new startUpServlet(gatewayInterface), null, null);
			/*
			 * Defines GetServiceDescriptor route
			 * "json/net/default/wsnnodes/services/"
			 */
			service.registerServlet(prefix + Resources.NWT_ROOT_URI + ResourcePathURIs.WSNNODES + ResourcePathURIs.SERVICES,
					new nodeServicesServlet(gatewayInterface), null, null);
			/*
			 * Defines LocalServices route "/net/default/localnode/services"
			 */
			service.registerServlet(prefix + Resources.NWT_ROOT_URI + ResourcePathURIs.LOCALNODE_SERVICES,
