...
/**
 * Appliance configuration object uses only end point specific configuration
 * properties
 * 
 */
public class ApplianceConfiguration implements IApplianceConfiguration {
	...
	private boolean updateEndPointProperty(Integer endPointId, String applianceProperty, String endPointProperty,
	...
	public boolean updateCategoryPid(Integer endPointId, String value) {
		return updateEndPointProperty(endPointId, IAppliance.APPLIANCE_CATEGORY_PID_PROPERTY,
				IAppliance.END_POINT_CATEGORY_PIDS_PROPERTY, value);
	}

	public boolean updateLocationPid(Integer endPointId, String value) {
		return updateEndPointProperty(endPointId, IAppliance.APPLIANCE_LOCATION_PID_PROPERTY,
				IAppliance.END_POINT_LOCATION_PIDS_PROPERTY, value);
	}
	...
	public String getCategoryPid(Integer endPointId) {
		return getEndPointProperty(endPointId, IAppliance.APPLIANCE_CATEGORY_PID_PROPERTY,
				IAppliance.END_POINT_CATEGORY_PIDS_PROPERTY);
	}

	public String getLocationPid(Integer endPointId) {
		return getEndPointProperty(endPointId, IAppliance.APPLIANCE_LOCATION_PID_PROPERTY,
