...
public class GetHolidayScheduleResponse {
	...
	public GetHolidayScheduleResponse(short HolidayScheduleID, short Status, long ZigBeeLocalStartTime, long ZigBeeLocalEndTime,
			short OperatingModeDuringHoliday) {
