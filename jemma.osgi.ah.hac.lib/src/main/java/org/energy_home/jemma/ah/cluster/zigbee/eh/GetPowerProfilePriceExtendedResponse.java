...
public class GetPowerProfilePriceExtendedResponse {
	...
	public GetPowerProfilePriceExtendedResponse() {
	}

	public GetPowerProfilePriceExtendedResponse(short PowerProfileID, int Currency, long Price, short PriceTrailingDigit) {
