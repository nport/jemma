...
public class PeerEndPoint extends BasicEndPoint implements IEndPoint {
	...
	private synchronized void addServiceCluster(PeerServiceCluster serviceCluster, IServiceCluster serviceClusterProxy)
	...
	public IEndPointRequestContext getPeerValidRequestContext(IEndPointRequestContext endPointRequestContext)
		...
		synchronized (this) {
			if (managedEndPointRequestContext == null || managedEndPointRequestContext.getPeerEndPoint() == null) {
				...
				managedEndPointRequestContext = new EndPointRequestContext(managedEndPoint.getPeerEndPoint(lep.getAppliance()
						.getPid(), lep.getId()));
			}
		}
