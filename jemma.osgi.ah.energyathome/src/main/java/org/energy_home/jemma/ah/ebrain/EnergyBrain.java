...
public class EnergyBrain implements IBasicApplianceListener {
	...
	private static final ICloudServiceProxy dummyHapProxy = new ICloudServiceProxy() {
		...
		/*
		 * Removed in demo_amsterdam version public void
		 * storeDeliveredPower(String applianceId, long time, float power)
		 * throws Exception { // TODO Auto-generated method stub
		 * 
		 * }
		 * 
		 * public void storeOnOffStatus(String appliancePid, long timestamp,
		 * boolean value) throws Exception { // TODO Auto-generated method stub
		 * 
		 * }
		 */
