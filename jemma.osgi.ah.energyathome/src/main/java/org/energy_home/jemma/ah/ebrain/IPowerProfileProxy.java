...
public interface IPowerProfileProxy {
	...
	// ------------------------------------------------------------------------------------------------------------
	public static final short ENERGY_FORMATTING_DECIMAL_DIGITS_MASK = 0x7; // bits
																			// 0-2
	public static final short ENERGY_FORMATTING_INTEGER_DIGITS_MASK = 0x38; // bits
																			// 3-6

	// ------------------------------------------------------------------------------------------------------------
	// GET&SET Attributes that are proxied to the remote zigbee device
	// ------------------------------------------------------------------------------------------------------------
	// this should not be necessary since this info is included in PP
	// notifications.
	short getTotalProfileNum(String applianceId);

	// this should not be necessary since we assume ALL white goods support
	// this.
	...
	// PowerProfileTimeConstraints retrieveProfileScheduleConstraints(String
	// applianceId, short powerProfileID);
	//
	// EnergyPhaseScheduleTime[] retrieveEnergyPhasesScheduleTime(String
	// applianceId, short powerProfileID);
