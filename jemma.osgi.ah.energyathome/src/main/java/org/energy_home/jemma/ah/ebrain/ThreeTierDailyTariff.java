...
public class ThreeTierDailyTariff extends DailyTariff {
	...
	public ThreeTierDailyTariff() throws Exception {
		...
		TariffIntervals[] workdays = new TariffIntervals[] { new TariffIntervals(F3_TARIFF, new int[] { 000, 800, 2300, 2400 }),
				new TariffIntervals(F2_TARIFF, new int[] { 800, 900, 2000, 2300 }),
				new TariffIntervals(F1_TARIFF, new int[] { 900, 2000 }) };

		TariffIntervals[] saturday = new TariffIntervals[] { new TariffIntervals(F3_TARIFF, new int[] { 000, 800, 2300, 2400 }),
				new TariffIntervals(F2_TARIFF, new int[] { 800, 2300 }) };
		TariffIntervals[] sunday = new TariffIntervals[] { new TariffIntervals(F3_TARIFF, new int[] { 000, 2400 }) };
