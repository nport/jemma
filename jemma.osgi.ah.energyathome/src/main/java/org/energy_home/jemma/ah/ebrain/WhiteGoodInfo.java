...
public class WhiteGoodInfo extends ApplianceInfo {
	 ...
	 * attribute is to be decoded as follows:
	 * <ul>
	 * <li>Bits 0 to 2: Number of Digits to the right of the Decimal Point.</li>
	 * <li>Bits 3 to 6: Number of Digits to the left of the</li>
	 * Decimal Point.</li>
	 * <li>Bit 7: If set, suppress leading zeros.
	 */
	...
	public PowerProfileInfo getPowerProfile(short profileId) {
		if (profileId >= powerProfileInfos.length)
			return null;
