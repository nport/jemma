...
public class PowerAndControlClusterProxySimpleTest extends PowerAndControlClusterProxy implements PowerProfileClient {
	...
	private static IPowerAndControlListener listener = new IPowerAndControlListener() {
		...
		public void notifyEnergyPhasesScheduleTime(String applianceId, short powerProfileID,
				EnergyPhaseScheduleTime[] scheduledPhases) {
			// TODO Auto-generated method stub
	...
	protected PowerProfileServer getRemotePowerProfileCluster(String applianceId) {
		return new PowerProfileServer() {
			...
			private PowerProfileTransferredPhase powerProfileTransferredPhase1 = new PowerProfileTransferredPhase((short) 1,
					(short) 2, 30, 40, 50, 60);
			private PowerProfileTransferredPhase powerProfileTransferredPhase2 = new PowerProfileTransferredPhase((short) 7,
					(short) 8, 90, 100, 110, 120);
			private PowerProfileTransferredPhase[] powerProfileTransferredPhases = new PowerProfileTransferredPhase[] {
					powerProfileTransferredPhase1, powerProfileTransferredPhase2 };
			private PowerProfileResponse powerProfileResponse = new PowerProfileResponse((short) 1, (short) 2,
					powerProfileTransferredPhases);
			...
			public boolean getMultipleScheduling(IEndPointRequestContext context) throws ApplianceException,
					ServiceClusterException {
				// TODO Auto-generated method stub
				return false;
			}
			...
			public PowerProfileStateResponse execPowerProfileStateRequest(IEndPointRequestContext context)
	...
	protected ApplianceControlServer getRemoteApplianceControlCluster(String applianceId) {
		return new ApplianceControlServer() {
			...
			public SignalStateResponse execSignalState(IEndPointRequestContext context) throws ApplianceException,
					ServiceClusterException {
				// TODO Auto-generated method stub
				return null;
			}
	...
	protected ApplianceStatisticsServer getRemoteApplianceStatisticCluster(String applianceId) {
		return new ApplianceStatisticsServer() {
			...
			public LogQueueResponse execLogQueueRequest(IEndPointRequestContext context) throws ApplianceException,
					ServiceClusterException {
				// TODO Auto-generated method stub
				return null;
			}
	...
	public static void main(String[] args) {
		try {
			...
			test.applianceStatisticsProxy.execLogNotification(System.currentTimeMillis(), 1, 5, new byte[] { 0x00, 0x01, 0x02,
					0x03, 0x04 }, null);
