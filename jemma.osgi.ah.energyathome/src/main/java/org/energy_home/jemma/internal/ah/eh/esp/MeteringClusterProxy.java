...
public class MeteringClusterProxy extends ServiceClusterProxy implements SimpleMeteringClient, IServiceClusterListener,
		IMeteringProxy {
	...
	public void subscribeIstantaneousDemand(String applianceId, long minReportingInterval, long maxReportingInterval,
			float deltaValue) {
	...
	public void subscribeCurrentSummationDelivered(String applianceId, long minReportingInterval, long maxReportingInterval,
			double deltaValue) {
		SubscriptionParameters params = new SubscriptionParameters(minReportingInterval, maxReportingInterval, deltaValue);
		// TODO: needs to be extended to manage multiple end points devices
		try {
	...
	public void subscribeCurrentSummationReceived(String applianceId, long minReportingInterval, long maxReportingInterval,
			double deltaValue) {
		SubscriptionParameters params = new SubscriptionParameters(minReportingInterval, maxReportingInterval, deltaValue);
		// TODO: needs to be extended to manage multiple end points devices
		try {
