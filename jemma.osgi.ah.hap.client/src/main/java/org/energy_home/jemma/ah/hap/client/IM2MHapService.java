 ...
 * 
 */
public interface IM2MHapService extends IHapCoreService {
	 ...
	 * 
	 * @return {@code true} if the client has successfully completed the authentication at startup, {@code false} otherwise
	 */
	 ...
	 * 
	 * @return The timestamp associated to the last successful batch request (-1 in case no successful batch request has been yet
	 *         completed)
	 */
	...
	public ContentInstanceItems getContentInstanceItems(AHContainerAddress containerAddress, long startInstanceId,
	...
	public ContentInstance createContentInstanceQueued(AHContainerAddress containerAddress, long instanceId, Object content,
			boolean sync) throws M2MHapException;

	public ContentInstance createContentInstanceQueued(AHContainerAddress containerAddress, ContentInstance contentInstance,
			boolean sync) throws M2MHapException;

	public ContentInstance getCachedLatestContentInstance(AHContainerAddress containerAddress) throws M2MHapException;

	public ContentInstanceItemsList getCachedLatestContentItemsList(AHContainerAddress containerAddressFilter)
			throws M2MHapException;
