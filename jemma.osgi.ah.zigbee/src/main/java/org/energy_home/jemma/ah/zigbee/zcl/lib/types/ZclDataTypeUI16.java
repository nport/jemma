...
public class ZclDataTypeUI16 extends ZclAbstractDataType {
	 ...
	 * 
	 * static synchronized public ZclDataTypeUI16 get() { try { if (instance ==
	 * null) instance = new ZclDataTypeUI16(null); } catch (Exception e) {
	 * e.printStackTrace(); } return instance; }
	 * 
	 * static public ZclDataTypeUI16 get(Object defaultValue) { try { return new
	 * ZclDataTypeUI16(defaultValue); } catch (Exception e) {
	 * e.printStackTrace(); } return null; }
	 * 
	 * protected ZclDataTypeUI16(Object defaultValue) throws
