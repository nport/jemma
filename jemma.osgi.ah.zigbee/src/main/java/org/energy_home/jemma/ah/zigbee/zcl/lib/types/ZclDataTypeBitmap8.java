...
public class ZclDataTypeBitmap8 extends ZclAbstractDataType {
	 ...
	 * 
	 * static synchronized public ZclDataTypeUI8 get() { try { if (instance ==
	 * null) instance = new ZclDataTypeUI8(null); } catch (Exception e) {
	 * e.printStackTrace(); } return instance; }
	 * 
	 * static public ZclDataTypeUI8 get(Object defaultValue) { try { return new
	 * ZclDataTypeUI8(defaultValue); } catch (Exception e) {
	 * e.printStackTrace(); } return null; }
	 * 
	 * protected ZclDataTypeUI8(Object defaultValue) throws
