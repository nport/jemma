...
public class ZclDataTypeString extends ZclAbstractDataType {
	 ...
	 * 
	 * static synchronized public ZclDataTypeString get() { try { if (instance
	 * == null) instance = new ZclDataTypeString(null); } catch (Exception e) {
	 * e.printStackTrace(); } return instance; }
	 * 
	 * static public ZclDataTypeString get(Object defaultValue) { try { return
	 * new ZclDataTypeString(defaultValue); } catch (Exception e) {
	 * e.printStackTrace(); } return null; }
	 * 
	 * protected ZclDataTypeString(Object defaultValue) throws
