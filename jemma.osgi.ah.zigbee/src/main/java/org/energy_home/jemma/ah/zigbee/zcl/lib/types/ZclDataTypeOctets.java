...
public class ZclDataTypeOctets extends ZclAbstractDataType {
	...
	/*
	 * private static final Integer MAX_VALUE = new Integer(0xffff); private
	 * static final Integer MIN_VALUE = new Integer(0x0000); private static
	 * final Integer STEP_VALUE = null;
	 * 
	 * 
	 * private static ZclDataTypeOctets instance = null;
	 * 
	 * static synchronized public ZclDataTypeOctets get() { try { if (instance
	 * == null) instance = new ZclDataTypeOctets(null); } catch (Exception e) {
	 * e.printStackTrace(); } return instance; }
	 * 
	 * static public ZclDataTypeOctets get(Object defaultValue) { try { return
	 * new ZclDataTypeOctets(defaultValue); } catch (Exception e) {
	 * e.printStackTrace(); } return null; }
	 * 
	 * protected ZclDataTypeOctets(Object defaultValue) throws
	 * ApplianceValidationException { super(Integer.class.getCanonicalName(),
	 * defaultValue, null, MIN_VALUE, MAX_VALUE, STEP_VALUE); }
	 * 
	 * public int zclGetDataType() { return ZCL_TYPE_UNSIGNED_8_BIT_INT; }
	 * 
	 * public boolean zclIsDescreteDataType() { return false; }
	 * 
	 * public int zclGetByteLength(Object value) throws ZclValidationException{
	 * return BYTE_ARRAY_LENGTH; }
	 * 
	 * public int zclParse(byte[] msg, int msgIndex, Object[] values, int
	 * valuesIndex) throws ZclValidationException { int i1 =
	 * ZclByteUtils._16BitLittleEndianToInt(msg, msgIndex); values[valuesIndex]
	 * = new Integer(i1); return msgIndex + 2; }
	 * 
	 * public int zclSerialize(Object value, byte[] msg, int msgIndex) throws
	 * ZclValidationException{ int l = ((Integer) value).intValue();
	 * ZclByteUtils._16BitsToLittleEndian(l, msg, msgIndex); return msgIndex +
	 * 2; }
	 */
