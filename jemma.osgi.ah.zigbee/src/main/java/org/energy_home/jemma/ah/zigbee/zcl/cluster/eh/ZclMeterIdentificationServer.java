...
public class ZclMeterIdentificationServer extends ZclServiceCluster implements MeterIdentificationServer, ZigBeeDeviceListener {
	...
	static {
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_CompanyName_NAME, new ZclAttributeDescriptor(0,
				ZclMeterIdentificationServer.ATTR_CompanyName_NAME, new ZclDataTypeString(16), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_MeterTypeID_NAME, new ZclAttributeDescriptor(1,
				ZclMeterIdentificationServer.ATTR_MeterTypeID_NAME, new ZclDataTypeUI16(), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_DataQualityID_NAME, new ZclAttributeDescriptor(4,
				ZclMeterIdentificationServer.ATTR_DataQualityID_NAME, new ZclDataTypeUI16(), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_CustomerName_NAME, new ZclAttributeDescriptor(5,
				ZclMeterIdentificationServer.ATTR_CustomerName_NAME, new ZclDataTypeString(16), null, false, 0));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_Model_NAME, new ZclAttributeDescriptor(6,
				ZclMeterIdentificationServer.ATTR_Model_NAME, new ZclDataTypeOctets(16), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_PartNumber_NAME, new ZclAttributeDescriptor(7,
				ZclMeterIdentificationServer.ATTR_PartNumber_NAME, new ZclDataTypeOctets(16), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_ProductRevision_NAME, new ZclAttributeDescriptor(8,
				ZclMeterIdentificationServer.ATTR_ProductRevision_NAME, new ZclDataTypeOctets(6), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_SoftwareRevision_NAME, new ZclAttributeDescriptor(10,
				ZclMeterIdentificationServer.ATTR_SoftwareRevision_NAME, new ZclDataTypeOctets(6), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_UtilityName_NAME, new ZclAttributeDescriptor(11,
				ZclMeterIdentificationServer.ATTR_UtilityName_NAME, new ZclDataTypeString(16), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_POD_NAME, new ZclAttributeDescriptor(12,
				ZclMeterIdentificationServer.ATTR_POD_NAME, new ZclDataTypeString(16), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_AvailablePower_NAME, new ZclAttributeDescriptor(13,
				ZclMeterIdentificationServer.ATTR_AvailablePower_NAME, new ZclDataTypeI24(), null, false, 1));
		attributesMapByName.put(ZclMeterIdentificationServer.ATTR_PowerThreshold_NAME, new ZclAttributeDescriptor(14,
				ZclMeterIdentificationServer.ATTR_PowerThreshold_NAME, new ZclDataTypeI24(), null, false, 1));
	}

	public ZclMeterIdentificationServer() throws ApplianceException {
		super();
	}
	...
	public int getMeterTypeID(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
	...
	public int getDataQualityID(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
			Integer objectResult = null;
	...
	public void setCustomerName(String CustomerName, IEndPointRequestContext context) throws ApplianceException,
	...
	public String getCustomerName(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
			String objectResult = null;
	...
	public byte[] getModel(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
	...
	public byte[] getPartNumber(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
			byte[] objectResult = null;
	...
	public byte[] getProductRevision(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
			byte[] objectResult = null;
	...
	public String getUtilityName(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
			String objectResult = null;
	...
	public String getPOD(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
			String objectResult = null;
	...
	public int getAvailablePower(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
			Integer objectResult = null;
	...
	public int getPowerThreshold(IEndPointRequestContext context) throws ApplianceException, ServiceClusterException {
		if (context != null) {
			Integer objectResult = null;
