...
public class ZclAirQualityServer extends ZclServiceCluster implements AirQualityServer, ZigBeeDeviceListener {
	...
	static {
		...
		attributeDescriptors[0] = new ZclAttributeDescriptor(0, ZclAirQualityServer.ATTR_AirQualityIndex_NAME,
	...
	public ZclAirQualityServer() throws ApplianceException {
		super();
	}
	...
	public boolean notifyZclFrame(short clusterId, IZclFrame zclFrame) throws Exception {
		...
		org.energy_home.jemma.ah.cluster.zigbee.lube.AirQualityClient c = ((org.energy_home.jemma.ah.cluster.zigbee.lube.AirQualityClient) getSinglePeerCluster((AirQualityClient.class
				.getName())));
		switch (commandId) {
		case 2:
	...
	protected IZclFrame parseExternalAirQualityIndexNotification(org.energy_home.jemma.ah.cluster.zigbee.lube.AirQualityClient o,
