...
public class ZclAddSceneResponse {

	public static AddSceneResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		AddSceneResponse r = new AddSceneResponse();
	...
	public static void zclSerialize(IZclFrame zclFrame, AddSceneResponse r) throws ZclValidationException {
	...
	public static int zclSize(AddSceneResponse r) throws ZclValidationException {
		int size = 0;
