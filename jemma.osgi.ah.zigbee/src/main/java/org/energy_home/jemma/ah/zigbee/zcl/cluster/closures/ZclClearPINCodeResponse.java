...
public class ZclClearPINCodeResponse {
	...
	public static ClearPINCodeResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		ClearPINCodeResponse r = new ClearPINCodeResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, ClearPINCodeResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(ClearPINCodeResponse r) throws ZclValidationException {
		int size = 0;
