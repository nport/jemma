...
public class ZclClearRFIDCodeResponse {
	...
	public static ClearRFIDCodeResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		ClearRFIDCodeResponse r = new ClearRFIDCodeResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, ClearRFIDCodeResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(ClearRFIDCodeResponse r) throws ZclValidationException {
		int size = 0;
