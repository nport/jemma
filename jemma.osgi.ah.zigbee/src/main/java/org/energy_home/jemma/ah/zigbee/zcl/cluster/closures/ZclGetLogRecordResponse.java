...
public class ZclGetLogRecordResponse {
	...
	public static GetLogRecordResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
	...
	public static void zclSerialize(IZclFrame zclFrame, GetLogRecordResponse r) throws ZclValidationException {
	...
	public static int zclSize(GetLogRecordResponse r) throws ZclValidationException {
		int size = 0;
