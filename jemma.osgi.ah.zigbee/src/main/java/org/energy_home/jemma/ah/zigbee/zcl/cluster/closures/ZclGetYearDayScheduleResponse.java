...
public class ZclGetYearDayScheduleResponse {
	...
	public static GetYearDayScheduleResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
	...
	public static void zclSerialize(IZclFrame zclFrame, GetYearDayScheduleResponse r) throws ZclValidationException {
	...
	public static int zclSize(GetYearDayScheduleResponse r) throws ZclValidationException {
		int size = 0;
