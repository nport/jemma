...
public class ZclClearYearDayScheduleResponse {
	...
	public static ClearYearDayScheduleResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		ClearYearDayScheduleResponse r = new ClearYearDayScheduleResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, ClearYearDayScheduleResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(ClearYearDayScheduleResponse r) throws ZclValidationException {
		int size = 0;
