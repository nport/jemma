...
public class ZclSetHolidayScheduleResponse {
	...
	public static SetHolidayScheduleResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		SetHolidayScheduleResponse r = new SetHolidayScheduleResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, SetHolidayScheduleResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(SetHolidayScheduleResponse r) throws ZclValidationException {
		int size = 0;
