...
public class ZclGetUserStatusResponse {
	...
	public static GetUserStatusResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
	...
	public static void zclSerialize(IZclFrame zclFrame, GetUserStatusResponse r) throws ZclValidationException {
		ZclDataTypeUI16.zclSerialize(zclFrame, r.UserID);
		ZclDataTypeUI8.zclSerialize(zclFrame, r.UserStatus);
	}

	public static int zclSize(GetUserStatusResponse r) throws ZclValidationException {
		int size = 0;
