...
public class ZclClearAllRFIDCodesResponse {
	...
	public static ClearAllRFIDCodesResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		ClearAllRFIDCodesResponse r = new ClearAllRFIDCodesResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, ClearAllRFIDCodesResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(ClearAllRFIDCodesResponse r) throws ZclValidationException {
		int size = 0;
