...
public class ZclSetPINCodeResponse {
	...
	public static SetPINCodeResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		SetPINCodeResponse r = new SetPINCodeResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, SetPINCodeResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(SetPINCodeResponse r) throws ZclValidationException {
		int size = 0;
