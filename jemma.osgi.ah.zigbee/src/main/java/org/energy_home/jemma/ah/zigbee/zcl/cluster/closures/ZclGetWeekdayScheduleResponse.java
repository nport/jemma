...
public class ZclGetWeekdayScheduleResponse {
	...
	public static GetWeekdayScheduleResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
	...
	public static void zclSerialize(IZclFrame zclFrame, GetWeekdayScheduleResponse r) throws ZclValidationException {
	...
	public static int zclSize(GetWeekdayScheduleResponse r) throws ZclValidationException {
		int size = 0;
