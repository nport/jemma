...
public class ZclClearWeekdayScheduleResponse {
	...
	public static ClearWeekdayScheduleResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		ClearWeekdayScheduleResponse r = new ClearWeekdayScheduleResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, ClearWeekdayScheduleResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(ClearWeekdayScheduleResponse r) throws ZclValidationException {
		int size = 0;
