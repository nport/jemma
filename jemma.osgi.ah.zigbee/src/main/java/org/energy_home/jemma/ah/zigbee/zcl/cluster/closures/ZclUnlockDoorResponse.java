...
public class ZclUnlockDoorResponse {
	...
	public static UnlockDoorResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		UnlockDoorResponse r = new UnlockDoorResponse();
		r.Status = ZclDataTypeEnum8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, UnlockDoorResponse r) throws ZclValidationException {
		ZclDataTypeEnum8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(UnlockDoorResponse r) throws ZclValidationException {
		int size = 0;
