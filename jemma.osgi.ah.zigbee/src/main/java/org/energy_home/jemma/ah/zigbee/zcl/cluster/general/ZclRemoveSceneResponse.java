...
public class ZclRemoveSceneResponse {
	...
	public static RemoveSceneResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
	...
	public static void zclSerialize(IZclFrame zclFrame, RemoveSceneResponse r) throws ZclValidationException {
	...
	public static int zclSize(RemoveSceneResponse r) throws ZclValidationException {
		int size = 0;
