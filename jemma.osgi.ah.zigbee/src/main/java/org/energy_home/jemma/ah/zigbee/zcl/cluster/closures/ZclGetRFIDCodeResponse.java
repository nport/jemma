...
public class ZclGetRFIDCodeResponse {
	...
	public static GetRFIDCodeResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
	...
	public static void zclSerialize(IZclFrame zclFrame, GetRFIDCodeResponse r) throws ZclValidationException {
	...
	public static int zclSize(GetRFIDCodeResponse r) throws ZclValidationException {
		int size = 0;
