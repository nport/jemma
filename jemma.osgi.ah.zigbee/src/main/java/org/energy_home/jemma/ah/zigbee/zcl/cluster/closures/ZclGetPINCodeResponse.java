...
public class ZclGetPINCodeResponse {
	...
	public static GetPINCodeResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
	...
	public static void zclSerialize(IZclFrame zclFrame, GetPINCodeResponse r) throws ZclValidationException {
	...
	public static int zclSize(GetPINCodeResponse r) throws ZclValidationException {
		int size = 0;
