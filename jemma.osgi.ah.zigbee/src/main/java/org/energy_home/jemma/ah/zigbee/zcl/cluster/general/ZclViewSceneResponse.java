...
public class ZclViewSceneResponse {
	...
	public static ViewSceneResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
	...
	public static void zclSerialize(IZclFrame zclFrame, ViewSceneResponse r) throws ZclValidationException {
	...
	public static int zclSize(ViewSceneResponse r) throws ZclValidationException {
