...
public class ZclSetUsertypeResponse {
	...
	public static SetUsertypeResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		SetUsertypeResponse r = new SetUsertypeResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, SetUsertypeResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(SetUsertypeResponse r) throws ZclValidationException {
		int size = 0;
