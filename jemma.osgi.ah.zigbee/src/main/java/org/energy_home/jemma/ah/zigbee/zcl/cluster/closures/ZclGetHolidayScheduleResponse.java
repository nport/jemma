...
public class ZclGetHolidayScheduleResponse {
	...
	public static GetHolidayScheduleResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
	...
	public static void zclSerialize(IZclFrame zclFrame, GetHolidayScheduleResponse r) throws ZclValidationException {
	...
	public static int zclSize(GetHolidayScheduleResponse r) throws ZclValidationException {
		int size = 0;
