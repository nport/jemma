 ...
 * 
 */
public class ZclWindowCoveringServer extends ZclServiceCluster implements WindowCoveringServer, ZigBeeDeviceListener {
	...
	static {
		...
		attributeDescriptors[0] = new ZclAttributeDescriptor(0, ZclWindowCoveringServer.ATTR_WindowCoveringType_NAME,
				new ZclDataTypeEnum8(), null, true, 1);
		attributeDescriptors[1] = new ZclAttributeDescriptor(1, ZclWindowCoveringServer.ATTR_PhysicalClosedLimitLift_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[2] = new ZclAttributeDescriptor(2, ZclWindowCoveringServer.ATTR_PhysicalClosedLimitTilt_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[3] = new ZclAttributeDescriptor(3, ZclWindowCoveringServer.ATTR_CurrentPositionLift_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[4] = new ZclAttributeDescriptor(4, ZclWindowCoveringServer.ATTR_CurrentPositionTilt_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[5] = new ZclAttributeDescriptor(5, ZclWindowCoveringServer.ATTR_NumberofActuationsLift_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[6] = new ZclAttributeDescriptor(6, ZclWindowCoveringServer.ATTR_NumberofActuationsTilt_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[7] = new ZclAttributeDescriptor(7, ZclWindowCoveringServer.ATTR_ConfigStatus_NAME,
				new ZclDataTypeBitmap8(), null, true, 1);
		attributeDescriptors[8] = new ZclAttributeDescriptor(8, ZclWindowCoveringServer.ATTR_CurrentPositionLiftPercentage_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[9] = new ZclAttributeDescriptor(9, ZclWindowCoveringServer.ATTR_CurrentPositionTiltPercentage_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[10] = new ZclAttributeDescriptor(16, ZclWindowCoveringServer.ATTR_InstalledOpenLimit_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[11] = new ZclAttributeDescriptor(17, ZclWindowCoveringServer.ATTR_InstalledClosedLimit_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[12] = new ZclAttributeDescriptor(18, ZclWindowCoveringServer.ATTR_InstalledOpenLimitTilt_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[13] = new ZclAttributeDescriptor(19, ZclWindowCoveringServer.ATTR_InstalledClosedLimitTilt_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[14] = new ZclAttributeDescriptor(20, ZclWindowCoveringServer.ATTR_VelocityLift_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[15] = new ZclAttributeDescriptor(21, ZclWindowCoveringServer.ATTR_AccelerationTimeLift_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[16] = new ZclAttributeDescriptor(22, ZclWindowCoveringServer.ATTR_DecelerationTimeLift_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[17] = new ZclAttributeDescriptor(23, ZclWindowCoveringServer.ATTR_Mode_NAME, new ZclDataTypeBitmap8(),
				null, true, 1);
		attributeDescriptors[18] = new ZclAttributeDescriptor(24, ZclWindowCoveringServer.ATTR_IntermediateSetpointsLift_NAME,
				new ZclDataTypeString(16), null, true, 1);
		attributeDescriptors[19] = new ZclAttributeDescriptor(25, ZclWindowCoveringServer.ATTR_IntermediateSetpointsTilt_NAME,
				new ZclDataTypeString(16), null, true, 1);
	...
	public ZclWindowCoveringServer() throws ApplianceException {
		super();
	}
