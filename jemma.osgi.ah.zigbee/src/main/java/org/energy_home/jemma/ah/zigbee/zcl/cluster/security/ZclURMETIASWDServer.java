...
public class ZclURMETIASWDServer extends ZclServiceCluster implements ZigBeeDeviceListener {

	public final static short CLUSTER_ID = 1282;
	final static String ATTR_MaxDurtation_NAME = "MaxDuration";
	...
	public ZclURMETIASWDServer() throws ApplianceException {
		super();
	}
	...
	public boolean notifyZclFrame(short clusterId, IZclFrame zclFrame) throws Exception {
		...
		if (responseZclFrame == null) {
			...
			device.post(ZclURMETIASWDServer.CLUSTER_ID, responseZclFrame);
		}
		return true;
	}
	...
	public void setIAS_CIE_Address(byte[] IAS_CIE_Address, IEndPointRequestContext context) throws ApplianceException,
		...
		issueSet(ZclURMETIASWDServer.CLUSTER_ID, zclFrame, attrId, context);
	}
