...
public class ZclDataTypeUI24 extends ZclAbstractDataType {
	 ...
	 * 
	 * static synchronized public ZclDataTypeUI24 get() { try { if (instance ==
	 * null) instance = new ZclDataTypeUI24(null); } catch (Exception e) {
	 * e.printStackTrace(); } return instance; }
	 * 
	 * static public ZclDataTypeUI24 get(Object defaultValue) { try { return new
	 * ZclDataTypeUI24(defaultValue); } catch (Exception e) {
	 * e.printStackTrace(); } return null; }
	 * 
	 * protected ZclDataTypeUI24(Object defaultValue) throws
