...
public class ZclClearAllPINCodesResponse {
	...
	public static ClearAllPINCodesResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		ClearAllPINCodesResponse r = new ClearAllPINCodesResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, ClearAllPINCodesResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(ClearAllPINCodesResponse r) throws ZclValidationException {
		int size = 0;
