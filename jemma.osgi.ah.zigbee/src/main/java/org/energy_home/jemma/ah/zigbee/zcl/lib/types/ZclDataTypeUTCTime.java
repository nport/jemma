...
public class ZclDataTypeUTCTime extends ZclAbstractDataType {
	...
	/*
	 * static final Short MAX_VALUE = new Short((short) 0xff); static final
	 * Short MIN_VALUE = new Short((short) 0x00); static final Short STEP_VALUE
	 * = null;
	 * 
	 * private static ZclDataTypeUTCTime instance = null;
	 * 
	 * static synchronized public ZclDataTypeUTCTime get() { try { if (instance
	 * == null) instance = new ZclDataTypeUTCTime(null); } catch (Exception e) {
	 * e.printStackTrace(); } return instance; }
	 * 
	 * static public ZclDataTypeUTCTime get(Object defaultValue) { try { return
	 * new ZclDataTypeUTCTime(defaultValue); } catch (Exception e) {
	 * e.printStackTrace(); } return null; }
	 * 
	 * protected ZclDataTypeUTCTime(Object defaultValue) throws
	 * ApplianceValidationException { super(Short.class.getCanonicalName(),
	 ...
	 * 
	 * public int zclGetByteLength(Object value) { return BYTE_ARRAY_LENGTH; }
	 * 
	 * public int zclParse(byte[] msg, int msgIndex, Object[] values, int
	 * valuesIndex) throws ZclValidationException { int l = 0xff &
	 * msg[msgIndex]; values[valuesIndex] = new Integer(l); return msgIndex + 1;
	 * }
	 * 
	 * public int zclSerialize(Object value, byte[] msg, int msgIndex) throws
	 * ZclValidationException { // TODO Auto-generated method stub return 0; }
	 */
