...
public class ZclDoorLockServer extends ZclServiceCluster implements DoorLockServer, ZigBeeDeviceListener {
	...
	static {
		...
		attributeDescriptors[0] = new ZclAttributeDescriptor(0, ZclDoorLockServer.ATTR_LockState_NAME, new ZclDataTypeEnum8(),
				null, true, 1);
		attributeDescriptors[1] = new ZclAttributeDescriptor(1, ZclDoorLockServer.ATTR_LockType_NAME, new ZclDataTypeEnum8(), null,
				true, 1);
		attributeDescriptors[2] = new ZclAttributeDescriptor(2, ZclDoorLockServer.ATTR_ActuatorEnabled_NAME,
				new ZclDataTypeBoolean(), null, true, 1);
		attributeDescriptors[3] = new ZclAttributeDescriptor(3, ZclDoorLockServer.ATTR_DoorState_NAME, new ZclDataTypeEnum8(),
				null, true, 1);
		attributeDescriptors[4] = new ZclAttributeDescriptor(4, ZclDoorLockServer.ATTR_DoorOpenEvents_NAME, new ZclDataTypeUI32(),
				null, true, 1);
		attributeDescriptors[5] = new ZclAttributeDescriptor(5, ZclDoorLockServer.ATTR_DoorClosedEvents_NAME,
				new ZclDataTypeUI32(), null, true, 1);
		attributeDescriptors[6] = new ZclAttributeDescriptor(6, ZclDoorLockServer.ATTR_OpenPeriod_NAME, new ZclDataTypeUI16(),
				null, true, 1);
		attributeDescriptors[7] = new ZclAttributeDescriptor(16, ZclDoorLockServer.ATTR_NumberofLogRecordsSupported_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[8] = new ZclAttributeDescriptor(17, ZclDoorLockServer.ATTR_NumberofTotalUsersSupported_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[9] = new ZclAttributeDescriptor(18, ZclDoorLockServer.ATTR_NumberofPINUsersSupported_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[10] = new ZclAttributeDescriptor(19, ZclDoorLockServer.ATTR_NumberofRFIDUsersSupported_NAME,
				new ZclDataTypeUI16(), null, true, 1);
		attributeDescriptors[11] = new ZclAttributeDescriptor(20,
				ZclDoorLockServer.ATTR_NumberofWeekDaySchedulesSupportedPerUser_NAME, new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[12] = new ZclAttributeDescriptor(21,
				ZclDoorLockServer.ATTR_NumberofYearDaySchedulesSupportedPerUser_NAME, new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[13] = new ZclAttributeDescriptor(22, ZclDoorLockServer.ATTR_NumberofHolidaySchedulesSupported_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[14] = new ZclAttributeDescriptor(23, ZclDoorLockServer.ATTR_MaxPINCodeLength_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[15] = new ZclAttributeDescriptor(24, ZclDoorLockServer.ATTR_MinPINCodeLength_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[16] = new ZclAttributeDescriptor(25, ZclDoorLockServer.ATTR_MaxRFIDCodeLength_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[17] = new ZclAttributeDescriptor(26, ZclDoorLockServer.ATTR_MinRFIDCodeLength_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[18] = new ZclAttributeDescriptor(32, ZclDoorLockServer.ATTR_EnableLogging_NAME,
				new ZclDataTypeBoolean(), null, true, 1);
		attributeDescriptors[19] = new ZclAttributeDescriptor(33, ZclDoorLockServer.ATTR_Language_NAME, new ZclDataTypeString(24),
				null, true, 1);
		attributeDescriptors[20] = new ZclAttributeDescriptor(34, ZclDoorLockServer.ATTR_LEDSettings_NAME, new ZclDataTypeUI8(),
				null, true, 1);
		attributeDescriptors[21] = new ZclAttributeDescriptor(35, ZclDoorLockServer.ATTR_AutoRelockTime_NAME,
				new ZclDataTypeUI32(), null, true, 1);
		attributeDescriptors[22] = new ZclAttributeDescriptor(36, ZclDoorLockServer.ATTR_SoundVolume_NAME, new ZclDataTypeUI8(),
				null, true, 1);
		attributeDescriptors[23] = new ZclAttributeDescriptor(37, ZclDoorLockServer.ATTR_Operatingmode_NAME,
				new ZclDataTypeEnum8(), null, true, 1);
		attributeDescriptors[24] = new ZclAttributeDescriptor(38, ZclDoorLockServer.ATTR_SupportedOperatingModes_NAME,
				new ZclDataTypeBitmap16(), null, true, 1);
		attributeDescriptors[25] = new ZclAttributeDescriptor(39, ZclDoorLockServer.ATTR_DefaultConfigurationRegister_NAME,
				new ZclDataTypeBitmap16(), null, true, 1);
		attributeDescriptors[26] = new ZclAttributeDescriptor(40, ZclDoorLockServer.ATTR_EnableLocalProgramming_NAME,
				new ZclDataTypeBoolean(), null, true, 1);
		attributeDescriptors[27] = new ZclAttributeDescriptor(41, ZclDoorLockServer.ATTR_EnableOneTouchLocking_NAME,
				new ZclDataTypeBoolean(), null, true, 1);
		attributeDescriptors[28] = new ZclAttributeDescriptor(42, ZclDoorLockServer.ATTR_EnableInsideStatusLED_NAME,
				new ZclDataTypeBoolean(), null, true, 1);
		attributeDescriptors[29] = new ZclAttributeDescriptor(43, ZclDoorLockServer.ATTR_EnablePrivacyModeButton_NAME,
				new ZclDataTypeBoolean(), null, true, 1);
		attributeDescriptors[30] = new ZclAttributeDescriptor(48, ZclDoorLockServer.ATTR_Wrongcodeentrylimit_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[31] = new ZclAttributeDescriptor(49, ZclDoorLockServer.ATTR_UserCodeTemporaryDisableTime_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[32] = new ZclAttributeDescriptor(50, ZclDoorLockServer.ATTR_SendPINovertheAir_NAME,
				new ZclDataTypeBoolean(), null, true, 1);
		attributeDescriptors[33] = new ZclAttributeDescriptor(51, ZclDoorLockServer.ATTR_RequirePINforRFOperation_NAME,
				new ZclDataTypeBoolean(), null, true, 1);
		attributeDescriptors[34] = new ZclAttributeDescriptor(52, ZclDoorLockServer.ATTR_ZigBeeSecurityLevel_NAME,
				new ZclDataTypeUI8(), null, true, 1);
		attributeDescriptors[35] = new ZclAttributeDescriptor(64, ZclDoorLockServer.ATTR_AlarmMask_NAME, new ZclDataTypeBitmap16(),
				null, true, 1);
		attributeDescriptors[36] = new ZclAttributeDescriptor(65, ZclDoorLockServer.ATTR_KeypadOperationEventMask_NAME,
				new ZclDataTypeBitmap16(), null, true, 1);
		attributeDescriptors[37] = new ZclAttributeDescriptor(66, ZclDoorLockServer.ATTR_RFOperationEventMask_NAME,
				new ZclDataTypeBitmap16(), null, true, 1);
		attributeDescriptors[38] = new ZclAttributeDescriptor(67, ZclDoorLockServer.ATTR_ManualOperationEventMask_NAME,
				new ZclDataTypeBitmap16(), null, true, 1);
		attributeDescriptors[39] = new ZclAttributeDescriptor(68, ZclDoorLockServer.ATTR_RFIDOperationEventMask_NAME,
				new ZclDataTypeBitmap16(), null, true, 1);
		attributeDescriptors[40] = new ZclAttributeDescriptor(69, ZclDoorLockServer.ATTR_KeypadProgrammingEventMask_NAME,
				new ZclDataTypeBitmap16(), null, true, 1);
		attributeDescriptors[41] = new ZclAttributeDescriptor(70, ZclDoorLockServer.ATTR_RFProgrammingEventMask_NAME,
				new ZclDataTypeBitmap16(), null, true, 1);
		attributeDescriptors[42] = new ZclAttributeDescriptor(71, ZclDoorLockServer.ATTR_RFIDProgrammingEventMask_NAME,
				new ZclDataTypeBitmap16(), null, true, 1);
	...
	protected IZclFrame parseOperationEventNotification(org.energy_home.jemma.ah.cluster.zigbee.closures.DoorLockClient o,
		...
		o.execOperationEventNotification(OperationEventSource, OperationEventCode, UserID, PIN, ZigBeeLocalTime, Data,
				endPoint.getDefaultRequestContext());
		return null;
	}

	protected IZclFrame parseProgrammingEventNotification(org.energy_home.jemma.ah.cluster.zigbee.closures.DoorLockClient o,
			IZclFrame zclFrame) throws ApplianceException, ServiceClusterException {
		...
		o.execProgrammingEventNotification(ProgramEventSource, OperationEventCode, UserID, PIN, UserType, UserStatus,
				ZigBeeLocalTime, Data, endPoint.getDefaultRequestContext());
		return null;
	}
