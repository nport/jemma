...
public class ZclEndPointFactory {
	...
	public static void addServiceClusters(ZclEndPoint endPoint, int profileId, int deviceId, final int[] clientClusterIds,
			final int[] serverClusterIds) throws ApplianceException {
