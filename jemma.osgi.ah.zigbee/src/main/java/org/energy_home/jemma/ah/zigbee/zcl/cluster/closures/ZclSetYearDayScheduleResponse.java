...
public class ZclSetYearDayScheduleResponse {
	...
	public static SetYearDayScheduleResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		SetYearDayScheduleResponse r = new SetYearDayScheduleResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, SetYearDayScheduleResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(SetYearDayScheduleResponse r) throws ZclValidationException {
		int size = 0;
