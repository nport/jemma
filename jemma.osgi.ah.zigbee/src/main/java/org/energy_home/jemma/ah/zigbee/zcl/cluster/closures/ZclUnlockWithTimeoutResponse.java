...
public class ZclUnlockWithTimeoutResponse {
	...
	public static UnlockWithTimeoutResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		UnlockWithTimeoutResponse r = new UnlockWithTimeoutResponse();
		r.Status = ZclDataTypeEnum8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, UnlockWithTimeoutResponse r) throws ZclValidationException {
		ZclDataTypeEnum8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(UnlockWithTimeoutResponse r) throws ZclValidationException {
		int size = 0;
