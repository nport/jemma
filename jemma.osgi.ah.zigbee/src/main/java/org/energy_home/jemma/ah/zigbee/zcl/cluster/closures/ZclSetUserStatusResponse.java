...
public class ZclSetUserStatusResponse {
	...
	public static SetUserStatusResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		SetUserStatusResponse r = new SetUserStatusResponse();
		r.Status = ZclDataTypeUI8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, SetUserStatusResponse r) throws ZclValidationException {
		ZclDataTypeUI8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(SetUserStatusResponse r) throws ZclValidationException {
		int size = 0;
