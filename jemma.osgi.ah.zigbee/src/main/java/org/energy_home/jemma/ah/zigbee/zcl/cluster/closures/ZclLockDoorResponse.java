...
public class ZclLockDoorResponse {
	...
	public static LockDoorResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		LockDoorResponse r = new LockDoorResponse();
		r.Status = ZclDataTypeEnum8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, LockDoorResponse r) throws ZclValidationException {
		ZclDataTypeEnum8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(LockDoorResponse r) throws ZclValidationException {
		int size = 0;
