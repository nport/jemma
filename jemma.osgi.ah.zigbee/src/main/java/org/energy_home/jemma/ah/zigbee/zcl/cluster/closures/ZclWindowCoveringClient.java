...
public class ZclWindowCoveringClient extends ZclServiceCluster implements ZigBeeDeviceListener, WindowCoveringClient {

	public final static short CLUSTER_ID = 258;

	public ZclWindowCoveringClient() throws ApplianceException {
		super();
	}
