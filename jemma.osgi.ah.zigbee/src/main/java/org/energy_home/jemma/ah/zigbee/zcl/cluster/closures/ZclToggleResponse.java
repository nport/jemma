...
public class ZclToggleResponse {
	...
	public static ToggleResponse zclParse(IZclFrame zclFrame) throws ZclValidationException {
		ToggleResponse r = new ToggleResponse();
		r.Status = ZclDataTypeEnum8.zclParse(zclFrame);
		return r;
	}

	public static void zclSerialize(IZclFrame zclFrame, ToggleResponse r) throws ZclValidationException {
		ZclDataTypeEnum8.zclSerialize(zclFrame, r.Status);
	}

	public static int zclSize(ToggleResponse r) throws ZclValidationException {
		int size = 0;
