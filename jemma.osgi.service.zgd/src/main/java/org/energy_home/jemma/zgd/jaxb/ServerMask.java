...
@XmlType(name = "ServerMask", propOrder = { "primaryTrustCenter", "backupTrustCenter", "primaryBindingTableCache",
		"backupBindingTableCache", "primaryDiscoveryCache", "backupDiscoveryCache", "networkManager" })
