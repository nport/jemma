...
@XmlType(name = "NetworkDescriptor", propOrder = { "extendedPanId", "logicalChannel", "stackProfile", "zigBeeVersion",
		"beaconOrder", "superFrameOrder", "permitJoining", "routerCapacity", "endDeviceCapacity", "nwkRootURI" })
