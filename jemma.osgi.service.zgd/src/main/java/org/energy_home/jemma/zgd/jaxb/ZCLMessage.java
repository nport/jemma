...
@XmlType(name = "ZCLMessage", propOrder = { "rxTime", "destinationEndpoint", "sourceAddress", "sourceEndpoint", "profileID",
		"clusterID", "zclPayload", "apsStatus", "sourceAddressMode", "zclHeader" })
