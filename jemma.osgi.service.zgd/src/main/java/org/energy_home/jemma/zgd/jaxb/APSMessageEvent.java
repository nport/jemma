...
@XmlType(name = "APSMessageEvent", propOrder = { "destinationAddressMode", "destinationAddress", "destinationEndpoint",
		"sourceAddress", "sourceAddressMode", "sourceEndpoint", "profileID", "clusterID", "data", "apsStatus", "securityStatus",
		"linkQuality", "rxTime" })
