...
@XmlType(name = "InterPANMessage", propOrder = { "srcAddressMode", "srcAddress", "srcPANID", "dstAddressMode",
		"destinationAddress", "destPANID", "profileID", "clusterID", "asduLength", "asdu", "asduHandle" })
