...
@XmlType(name = "InterPANMessageEvent", propOrder = { "callbackIdentifier", "srcAddressMode", "srcAddress", "dstAddressMode",
		"dstAddress", "srcPANID", "dstPANID", "profileID", "clusterID", "asduLength", "asdu", "linkQuality" })
