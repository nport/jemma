...
@XmlType(name = "ZCLCommand", propOrder = { "destinationAddressMode", "destinationAddress", "destinationEndpoint", "profileID",
		"clusterID", "sourceEndpoint", "txOptions", "radius", "zclPayload", "zclHeader" })
