...
public interface GatewayInterface {
	 ...
	 * @throws GatewayException
	 */
	ServiceDescriptor getServiceDescriptorSync(long timeout, Address addrOfInterest, short endpoint) throws IOException, Exception,
			GatewayException;
	 ...
	 * @throws GatewayException
	 */
	Status frequencyAgilitySync(long timeout, short scanChannel, short scanDuration) throws IOException, Exception,
			GatewayException;
