...
@XmlType(name = "Info", namespace = "http://www.zigbee.org/GWGRESTSchema", propOrder = { "status", "requestIdentifier",
		"eventCallbackIdentifier", "nwkStatus", "detail" })
public class Info implements Serializable {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "version", "value", "lqiInformation", "polledMessage", "callbackIdentifier", "callbacks",
			"aliases", "wsnNode", "wsnNodes", "nodeServices", "serviceDescriptor", "nodeServicesList", "startupAttributeInfo",
			"zdpMessage", "zclCommandResult", "zclMessage", "endpoint", "groups", "bindings", "apsMessageEvent",
			"apsMessageResult", "nodeDescriptor", "powerDescriptor", "userDescriptor", "networkDescriptors", "energyScanResult",
			"networkStatusCode", "nwkMessageEvent", "nwkMessageResult", "interPANMessageEvent", "interPANMessageResult" })
