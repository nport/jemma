...
@XmlType(name = "NodeDescriptor", propOrder = { "logicalType", "complexDescriptorAvailable", "userDescriptorAvailable",
		"frequencyBand", "macCapabilityFlag", "manufacturerCode", "maximumBufferSize", "maximumIncomingTransferSize", "serverMask",
		"maximumOutgoingTransferSize", "descriptorCapabilityField" })
