...
@XmlType(name = "APSMessage", propOrder = { "destinationAddressMode", "destinationAddress", "destinationEndpoint",
		"sourceEndpoint", "profileID", "clusterID", "data", "txOptions", "radius" })
