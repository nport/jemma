...
import org.energy_home.jemma.ah.m2m.device.M2MHttpStatusException;
import org.energy_home.jemma.ah.m2m.device.M2MServiceException;
import org.energy_home.jemma.ah.m2m.device.M2MUnauthorizedException;
...
class M2MUtils {
	...
	// FIXME this pattern to be checked carefully and documented: it seems legit - but it's risky - Why am I passing logger to this
	// function ?
