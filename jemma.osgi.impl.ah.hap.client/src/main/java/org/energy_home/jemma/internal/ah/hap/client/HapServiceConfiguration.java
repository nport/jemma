...
public class HapServiceConfiguration {
	...
	public static final String BATCH_REQUESTS_DIR_NAME_PREFIX = "org.energy_home.jemma.ah.hap.client.";
	...
	public static String BATCH_REQUESTS_DIR_NAME;
	...
	public static synchronized void init() {
		...
		if (!Utils.isNullOrEmpty(cacheDirName)) {
			...
			BATCH_REQUESTS_DIR_NAME = cacheDirName + "/" + BATCH_REQUESTS_DIR_NAME_PREFIX;
		}
		// FIXME by Riccardo why all these String.format just for log messages ?
		LOG.debug(String.format("BATCH_REQUESTS_DIR_NAME: %s", BATCH_REQUESTS_DIR_NAME));
