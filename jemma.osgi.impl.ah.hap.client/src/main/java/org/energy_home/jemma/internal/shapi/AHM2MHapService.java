...
public class AHM2MHapService {
	...
	private M2MHapService m2mHapService = null;
	...
	public AHM2MHapService(M2MHapService hapService) {
		this.m2mHapService = hapService;
	}

	public DeviceCategory getDeviceCategory(String appliancePid, Integer endPointId) {
		ContentInstance epCategoryCi = getLocalContentInstance(appliancePid, endPointId,
				AHContainers.attrId_ah_core_config_category);
	...
	public ContentInstance sendAttributeValue(String attributeId, long timestamp, Object value, boolean batchRequest)
			throws HacException {
		return sendAttributeValue(null, null, attributeId, timestamp, value, batchRequest);
	}

	public ContentInstance sendAttributeValue(String attributeId, IAttributeValue attributeValue, boolean batchRequest)
			throws HacException {
	...
	public String getLocalAddressedId(String appliancePid, Integer endPointId, String attributeId) {
		AHContainerAddress containerId = m2mHapService.getLocalContainerAddress(appliancePid,
				(endPointId != null ? endPointId.toString() : null), attributeId);
		if (containerId == null)
			return null;
		else
	...
	public ContentInstance sendAttributeValue(String appliancePid, Integer endPointId, String attributeId, long timestamp,
			Object value, boolean batchRequest) throws HacException {
		try {
			AHContainerAddress containerId = m2mHapService.getHagContainerAddress(appliancePid,
					(endPointId != null ? endPointId.toString() : null), attributeId);
			if (batchRequest)
	...
	public void sendAttributeValue(String appliancePid, Integer endPointId, String attributeId, IAttributeValue attributeValue,
			boolean batchRequest) throws HacException {
		sendAttributeValue(appliancePid, endPointId, attributeId, attributeValue.getTimestamp(), attributeValue.getValue(),
				batchRequest);
	}
	...
	public ContentInstance storeAttributeValue(String attributeId, IAttributeValue attributeValue, boolean sync)
			throws HacException {
		return storeAttributeValue(null, null, attributeId, attributeValue.getTimestamp(), attributeValue.getValue(), sync);
	}

	public ContentInstance storeAttributeValue(String appliancePid, Integer endPointId, String attributeId, long timestamp,
			Object value, boolean sync) throws HacException {
		try {
			AHContainerAddress containerId = m2mHapService.getHagContainerAddress(appliancePid,
					(endPointId != null ? endPointId.toString() : null), attributeId);
	...
	public ContentInstance storeAttributeValue(String appliancePid, Integer endPointId, String attributeId,
		...
		return storeAttributeValue(appliancePid, endPointId, attributeId, attributeValue.getTimestamp(), attributeValue.getValue(),
				sync);
	}
	...
	public IAttributeValue getAttributeValue(String appliancePid, Integer endPointId, String attributeId, long timestamp)
			throws HacException {
		try {
			AHContainerAddress containerId = m2mHapService.getHagContainerAddress(appliancePid,
					(endPointId != null ? endPointId.toString() : null), attributeId);
