function showSpinner() {
	if ($('#progress').length == 0) {
		$('body').append(
				$(document.createElement('div')).attr('id', 'progress').attr(
						'class', 'boxProgress').append(
						$(document.createElement('img')).attr('src',
								'plugins/spinner/ajax-loader.gif')));
	}
...
function showSpinnerConf() {
	if ($('#progress').length == 0) {
		$('body')
				.append(
						'<div id="progress" class="boxProgress" ><img src="../js/other/ajax-loader.gif"></div>');
	}
...
function showSpinnerElettro() {
	if ($('#progressElettro').length == 0) {
		$('body').append(
				$(document.createElement('div')).attr('id', 'progressElettro')
						.attr('class', 'boxProgressElettro').append(
								$(document.createElement('img')).attr('src',
										'./js/other/ajax-loader.gif')));
	}
