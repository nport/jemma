...
//Metodo che gestisce i valori relativi al contatore dei consumi (sempre presente in tutte e due le modalit�)
...
Main.VisError = function(err) {
	...
	//Visualizzo il nuovo messaggio di errore solo se non � gi� presente
