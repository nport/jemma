...
Storico.ExitStorico = function() {
	...
	//console.log(20, Storico.MODULE, "ExitStorico");
...
Storico.VisStorico = function(tipo) {
	...
	if (Storico.periodoScelto == Storico.GIORNO) {
		...
		titolo = Msg.home["giornoGrafStorico"] + ":  "
				+ Storico.dataInizio.getDate() + "  "
	...
	if (Storico.datiConsumo == null) {
		$("#MsgStorico").hide();
		//console.log(40, Storico.MODULE, "VisStorico : nessun dato");
	...
	if (Storico.datiConsumo != null){
		...
		//console.log(40, Storico.MODULE, "VisStorico : dati1 da Storico.datiConsumo = " + dati1);
	}
	if (Main.enablePV){
		if (Storico.datiProduzione != null){
			dati2 = Storico.datiProduzione.slice(0);
			//console.log(40, Storico.MODULE, "VisStorico : dati2 da Storico.datiProduzione = " + dati2);
		}
	} else {
		if (Storico.datiCosto != null){
			dati2 = Storico.datiCosto.slice(0);
			//console.log(40, Storico.MODULE, "VisStorico : dati2 da Storico.datiCosto = " + dati2);
		}
	}
	...
	for (i = 0; i < dati1.length; i++) {
		...
		if (Storico.periodoScelto == Storico.GIORNO) {
			...
			//console.log(80, Storico.MODULE, "VisStorico : ora = " + tickers[i]);
			ruota = 0;
			min = 0;
			max = 23;
			yOffset = 20;
	...
	//console.log(40, Storico.MODULE, "VisStorico bis : dati2 da Storico.datiCosto = " + dati2);
	...
	if (tipo == Storico.COSTI_CONSUMI) {
		...
		//console.log(20, Storico.MODULE, "VisStorico: maxConsumo = " + maxConsumo + " maxCosto = " + maxCosto + " rapp = " + rapp);
	...
	Highcharts.setOptions({
		colors : [ 'blue', "green", '#ED561B', '#DDDF00', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4' ]
	});
...
Storico.DatiConsumoStorico = function(val) {
	...
	//console.log('datiConsumi Consumi dal server', val);
	Storico.datiConsumo = val;
	if (val == null){
		//console.log(80, Storico.MODULE, "DatiConsumoStorico null");
	}
	hideSpinner();
	//console.log(80, Storico.MODULE, "DatiConsumoStorico = " + val);
...
Storico.DatiCostoStorico = function(val) {
	//console.log('datiCosti Costi dal server', val);
	Storico.datiCosto = val;
	if (val == null){
		//console.log(80, Storico.MODULE, "DatiCostoStorico null");
	}

	//console.log(80, Storico.MODULE, "DatiCostoStorico = " + val);
...
Storico.GetStorico = function() {
	Main.ResetError();
	showSpinner();
	//console.log(20, Storico.MODULE, "Dispositivo= " + Storico.dispositivoScelto + " Periodo = " + Storico.periodoScelto);
	//console.log(20, Storico.MODULE, "============ GetStorico: inizio = " + Storico.dataInizio.toString() + " fine = " + Storico.dataFine.toString());

	// imposta id del dispositivo selezionato
	Storico.device = Storico.GetDispId(Storico.dispositivoScelto);
	//console.log(80, Storico.MODULE, "Periodo: pid = " + Storico.device + " inizio = " + Storico.dataInizio.toString() + " fine = " + Storico.dataFine.toString());
...
Storico.SceltaPeriodo = function() {
	...
	//console.log(20, Storico.MODULE, "========== SceltaPeriodo: precedente = " + Storico.tipoUltimoPeriodo + " nuovo = " + Storico.periodoScelto);
	if (Storico.periodoScelto != Storico.tipoUltimoPeriodo) {
		...
		//console.log(80, Storico.MODULE, "SceltaPeriodo: non ho cambiato tipo di periodo");
	}
}
...
Storico.Precedente = function() {
	//console.log(20, Storico.MODULE, "============ Precedente: periodoScelto = " + Storico.periodoScelto);
	switch (Storico.periodoScelto) {
		case Storico.GIORNO:
...
Storico.Successivo = function() {
	//console.log(20, Storico.MODULE, "=========== Successivo: periodoScelto = " + Storico.periodoScelto);
	switch (Storico.periodoScelto) {
		case Storico.GIORNO:
			Storico.dataInizio.setDate(Storico.dataInizio.getDate() + 1);
			Storico.dataFine.setDate(Storico.dataFine.getDate() + 1);
...
Storico.VisScelta = function() {
	...
	//console.log(80, Storico.MODULE, "dispositivoScelto = " + Storico.dispositivoScelto + " periodoScelto = " + Storico.periodoScelto);
...
Storico.DatiElettr = function(val) {
	//console.log(80, Storico.MODULE, "Storico.DatiElettr ");
...
Storico.GestStorico = function() {
	//console.log(80, Storico.MODULE, "Storico.GestStorico");
	/*
