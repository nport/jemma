var ifWindowCovering = {
	...
	liftPerc : 50,
	isBusy : false,
	stato : 6, // 6 = finestra aperta, 7 = finestra chiusa, 8 = finestra semi
	// aperta
...
ifWindowCovering.updateIcon = function() {
	...
	var icona_src = "Resources/Images/Devices/"
			+ Elettrodomestici.getIcon(Elettrodomestici.listaElettrodomestici[i], ifWindowCovering.stato);
...
ifWindowCovering.update = function() {
	...
	// ifWindowCovering.liftPerc = liftPerc =
	// Elettrodomestici.listaElettrodomestici[i].device_value;
...
ifWindowCovering.gestUpdate = function() {
	...
	$("#Interfaccia .StatoElettrodomestico .posizione_value").text(
			Elettrodomestici.locazioni[Elettrodomestici.listaElettrodomestici[i].location]);
